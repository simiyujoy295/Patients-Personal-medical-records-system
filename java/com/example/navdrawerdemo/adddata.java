...
{
    EditText name,course,email,purl,diagnosis,med,dep,date;
    Button submit,back;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        diagnosis=(EditText)findViewById(R.id.add_diagnosis) ;
        med=(EditText)findViewById(R.id.add_med);
        dep=(EditText)findViewById(R.id.add_dep);
    ...
    private void processinsert()
    {
        ...
        map.put("med",med.getText().toString());
